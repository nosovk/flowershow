...
Результат работы workflows мы можем складывать в BQ или PG. Так же в нем удобно реализовать отправку отчетов или алертов.
...
- раздел отчеты
	...
	- spend (все пользователи, фильт по себе для баеров)
