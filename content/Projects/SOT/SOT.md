...
Неясна судьба регистрации через телеграм — телеграм не содержит емейла, вероятно для регистрации через телеграм необходимо реализовывать какую-то дополнительную логику (к примеру подписка на канал в телеге).
