...
- Math
	...
	- math: обертки над rng под каждую конкретную игру, с логикой преобразования случайных чисел в коэффициенты
	- math-gateway: запускатель для математики с еденным контрактом (запускает math, который запускает RNG)
## People
