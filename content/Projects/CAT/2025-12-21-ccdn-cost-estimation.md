...
| ----------------------------- | ------------ | -------------------------------------- | ------------------- | -------------------------------------------------------------------------- |
| **1. Разработка MVP**         | 1.5 - 2 мес. | 1 DevOps/SRE<br>1 DevOps/SRE            | ~3.0 FTE-months     | Создание Edge-образа, агента конфигурации |
| **2. Приведение в экплуатируемый вид**   | 1 - 1.5 мес.       | 1 DevOps/SRE (50%) + 1 Full Stack (100%) | ~1.5-2 FTE-months     | Добавление базового CI/CD и Control Plane.           |
| **3. Доработка   функционала** | вечный процесс      | 0.5 - 1 FTE DevOps + 1 Full Stack (20%-50%)                            | 0.5 - 1 FTE/мес.    | Реализация сложной логики (WAF, trafik monitoring, ddos).                          |
...
## Costs Calculation
Будем изменять стоимость в Full Time Employee (FTE), где 1 FTE = 40 часов в неделю.
