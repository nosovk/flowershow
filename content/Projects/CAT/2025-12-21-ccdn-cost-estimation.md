...
| **2. Приведение в экплуатируемый вид**   | 1 - 1.5 мес.       | 1 DevOps/SRE (50%)<br>1 Full Stack (100%) | ~1.5-2 FTE-months     | Добавление базового CI/CD и Control Plane.           |
| **3. Доработка   функционала** | вечный процесс      | 0.5 - 1 FTE                            | 0.5 - 1 FTE/мес.    | Реализация сложной логики (WAF, trafik monitoring, ddos).                          |
