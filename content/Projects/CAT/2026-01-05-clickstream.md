...
# Реализация
в каждом проекте добавлен скрипт '/event-stream/script/webs.min.js', к примеру
- https://catcasino.com/event-stream/script/webs.min.js
- https://arkada.casino/event-stream/script/webs.min.js
- https://daddy.casino/event-stream/script/webs.min.js
...
```html
<script async src="/event-stream/script/webs.min.js" type="module"></script>
```

## применение скрипта

### 3 типа события размечаются дата-атрибутами.
