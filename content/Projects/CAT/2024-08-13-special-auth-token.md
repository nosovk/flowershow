...
## Conclusion
Предложенный механизм минимизирует риски безопасности и пытается свести к минимуму необходимости в доработке платформы. 
...
Предложенная реализация покрывает описананные сценарии и может быть расширена добавлением новых данных для принятия решений в "/refresh" метод

### 3rd party cookies
Очень долго всех пугали скорой отменой cookies, но в итоге, недавно постановили что будут продолжать их использовать. [Гугл свернул свой проект по отказу от cookies](https://www.singlegrain.com/blog/google-stops-third-party-cookie-deprecation).