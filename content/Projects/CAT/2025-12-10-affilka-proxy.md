...
Предполагаемое решение: добавить возможность передавать real user ip в специальном заголовке. Тогда и статистика будет работать, и редиректить будет согласно настроек аффилки и использовать мы сможем такое решене не только на CF, но и на других платфомрах (как-то Fastly или CCDN)
