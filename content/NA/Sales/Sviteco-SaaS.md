...
Необходимо построить платформу для сбора данных с клиентских устройств (к примеру счетчики электричества)
...
По составу команды: предлагается devops, backend nodejs, 2x full stack